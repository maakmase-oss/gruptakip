...
export default function Home(){
 const [accounts,setAccounts]=useState([]); const [aid,setAid]=useState("main"); const [groups,setGroups]=useState([]); const [events,setEvents]=useState([]); const [name,setName]=useState(""); const [loading,setLoading]=useState(false); const [groupsOpen,setGroupsOpen]=useState(false);
